export type UnknowObject = Record<string | symbol, unknown>;
...
export const isObject = (val: unknown): val is UnknowObject => val !== null && typeof val === 'object';
...
export const hasOwn = (val: UnknowObject, key: string | symbol): key is keyof typeof val =>
